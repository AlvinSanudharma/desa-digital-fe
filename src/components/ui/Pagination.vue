    ...
    <ul class="flex items-center gap-3">
      <li class="group">
        <a
          ...
          disabled
          class="flex size-11 shrink-0 items-center justify-center rounded-full bg-desa-foreshadow disabled:!bg-desa-foreshadow group-hover:bg-desa-dark-green transition-setup"
        >
          <img
